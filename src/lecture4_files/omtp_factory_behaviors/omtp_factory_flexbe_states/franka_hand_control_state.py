...
class MoveitToJointsState(EventState):
	...
	def __init__(self, move_group = 'panda_hand_1', joint_names = '[panda_1_finger_joint1, panda_1_finger_joint2]', action_topic = '/move_group'):
		'''
		Constructor
		'''
